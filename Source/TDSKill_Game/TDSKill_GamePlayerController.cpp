...
ATDSKill_GamePlayerController::ATDSKill_GamePlayerController()
{
	bShowMouseCursor = true;
	DefaultMouseCursor = EMouseCursor::Crosshairs;
}

void ATDSKill_GamePlayerController::PlayerTick(float DeltaTime)
{
...
void ATDSKill_GamePlayerController::MoveToMouseCursor()
{
	...
	{
		if (ATDSKill_GameCharacter* MyPawn = Cast<ATDSKill_GameCharacter>(GetPawn()))
		{
